...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	*/
	 ...
	 */
	HANDLE handleB = CreateProcess(NULL, commandLine, &saProcess, &saThread,
	...
	if (!SetEnvironmentVariable("PID_B", GetProcessId(piProcessB.hProcess)) 
			|| !SetEnvironmentVariable("PID_HANDLE", piProcessB.hProcess)) {
	 ...
	 */
	HANDLE handleC = CreateProcess(NULL, commandLine, NULL, NULL, TRUE, 
	...
	MessageBox(NULL, TEXT("Process C will be resumed in 5 secs"), TEXT("Process A"), MB_OK);
	Sleep(5000);
